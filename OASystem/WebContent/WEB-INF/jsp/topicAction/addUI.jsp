		...
		<center>
			<div class="ItemBlock_Title1">
				<div width=85% style="float:left">
					...
					<font class="MenuPoint"> &gt; </font>
					<s:a action="forumAction_show?id=%{#forum.id}">${forum.title}</s:a>
					<font class="MenuPoint"> &gt;&gt; </font>
					发表新主题
				</div>
			</div>
					...
					<tr height="240">
						...
						<td class="InputAreaBg">
							<div class="InputContent">
								<s:textarea name="content" cssStyle="width:650px;height:200px" id="editor1"></s:textarea>
								<script>
								CKEDITOR.replace( 'editor1', {customConfig: 'addconfig.js'});
								</script>
							</div>
						</td>

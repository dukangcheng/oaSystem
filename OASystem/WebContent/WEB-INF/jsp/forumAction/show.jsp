...
<html>
<head>
<title>【${forum.title}】中的主题列表</title>
	...
	<s:form action="forumAction_show?id=%{id}">
		...
		<div id="MainArea">
			...
			<div class="ItemBlock_Title1" style="width: 98%;">
				...
				<s:a action="forumAction_list">论坛列表</s:a>
				<font class="MenuPoint"> &gt;${forum.title} </font> <span
				...
				<div id="TableTail">
					<div id="TableTail_inside">
						<table border="0" cellspacing="0" cellpadding="0" height="100%"
							...
							<tr valign=bottom>
								<td></td>
								<td><s:select name="showType" list="#{0:'全部主题', 1:'全部精华贴'}" />
									<s:select name="orderBy" onchange="onSortByChange(this.value)" value="orderBy"

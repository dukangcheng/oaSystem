...
<div id=MainArea>
    ...
    <s:form action="userAction_%{id == 0 ? 'add' : 'edit'}">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                  <tr>
                   <td colspan="3"><!-- 显示错误 -->
				        <font color="red"><s:fielderror name="add"/></font>
                    </td>
                    </tr>
                    <tr>
                    	<td width="100">所属部门</td>
                        <td>
                            <s:select name="orgnizationId" cssClass="SelectStyle"
                            	list="#orgnizationList" listKey="id" listValue="name"
